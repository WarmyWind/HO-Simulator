...
train_set_name = 'scene0_large_h_train_0514.npy'
valid_set_name = 'scene0_large_h_valid_0514.npy'
train_set_root_path = 'Dataset/0514_scene0'
valid_set_root_path = 'Dataset/0514_scene0'
...
if __name__ == '__main__':
    ...
    if os.path.isfile(train_set_path):
        ...
        x_large_h, x_posi_real, x_posi_imag, y_large_h, y_posi_real, y_posi_imag = generate_dataset(shadow_filepath, UE_posi_train_filepath_list, PARAM)
    ...
    if os.path.isfile(valid_set_path):
        ...
        x_large_h, x_posi_real, x_posi_imag, y_large_h, y_posi_real, y_posi_imag = generate_dataset(shadow_filepath, UE_posi_valid_filepath_list, PARAM)
